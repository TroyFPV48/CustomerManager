...
public class LinkedList<E> implements LinkedListInterface<E> {
 ...
 // post : returns the position of the first occurrence of the given
    ...
    public void addAll(LinkedList<E> other) {
    	iterateLinkedList(other);      
    }
    
    public void iterateLinkedList(LinkedList<E> linkedList){
	...
	public E get(E value, boolean searchFromBack) {
		...
		ListNode<E> current;
        if (searchFromBack) {
            current = back; //current strat from back Node
            ...
            current = front; //current start searching from frontNode
	...
	public int indexOf(E value, boolean searchFromBack) {
		// TODO Auto-generated method stub
				...
				int index;
		        if (searchFromBack) {
		            current = back; //current start from back Node
	...
	public void addAtEnd(E value) {
		// TODO Auto-generated method stub	
    		...
    		ListNode<E> current = front; //start counting from first node
    		while(current.next != null) {
    			current = current.next;
    		}
    		current.next = newNode; //add new data by assigning last Node's next to it which is null
